...
(function (_4TellBoost, $, undefined) {
    ...
    _4TellBoost.getPageSettings = function (pageType) {
        ...
        switch (pageType) {
            case 'Home': //home page
                tout1.enable = true;
                tout1.divSelect = "table[width='98%']";
            ...
            case 'ProductDetail':
                ...
                tout1.numItems = Math.max(3, Math.round($("#4TELLFOO").outerHeight() / 230));
                tout1.caption = 'Customers also bought';
                tout1.captionStyle = 'checkout-headers product4TCaption product4TCaptionPD1';
                tout1.productStyle = 'product4T product4TPD1';
                tout1.showBuyButton = true;

                tout2.enable = true;
                tout2.divSelect = "#second4TellContainer";
