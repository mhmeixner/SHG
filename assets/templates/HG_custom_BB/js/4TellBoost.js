...
if (typeof JSON == 'undefined') {
    document.write("<script type=\"text/javascript\" src=../../Copy of HG_custom/js//"assets/templates/common/js/json2.js/"></" + "script>");
    var __noconflict = true;
}
...
(function (_4TellBoost, $, undefined) {
    ...
    _4TellBoost.getRecommendations = function (pageType, productIDs) {
        if (!_4TellBoost.SiteInfo.SiteEnable)
            return; //Site's not yet live. 
    ...
    _4TellBoost.setPageType = function (pageType) {
        ...
        if (pageType == "ProductDetail") {
            var lastViewed = _4TellBoost.Service.productList[Service.productCount - 1];
